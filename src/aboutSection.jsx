    ...
    <div className="bg-gradient-to-b from-green-100 to-white p-8">
      <div className="container mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h2 className="text-3xl font-bold text-green-600 mb-4">Who are <span className="text-teal-500">we?</span></h2>
          <div className="flex flex-col lg:flex-row items-center lg:items-start">
            ...
            <div className="lg:w-1/3 lg:pl-8">
              <img src="/path/to/your/logo.png" alt="HEMMA Logo" className="rounded-lg shadow-md" />
            </div>
          </div>
        </div>
