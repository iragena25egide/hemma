    ...
    <div className="bg-gray-100">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gray-900 bg-opacity-80 flex flex-col justify-center items-center text-center px-6">
          {/* Heading */}
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight">Meet Our Team</h1>
          {/* Description */}
      ...
      <div className="py-12 max-w-7xl mx-auto px-6 lg:px-8">
        {/* Team Categories */}
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Our Dedicated Team</h2>
        ...
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Team Categories</h2>
