...
const Servicepage = () => {
  ...
  <div className="absolute inset-0 bg-black bg-opacity-80 flex flex-col justify-center items-center text-center">
    <h1 className="text-5xl font-bold text-white mb-4">Hemma Investment Services</h1>
...
<div className="py-12 max-w-7xl mx-auto px-6 lg:px-8">
  ...
  <div className="mb-12 flex flex-col md:flex-row items-center justify-between px-6">
    <div className="md:w-1/2 flex flex-col justify-between h-full mb-6 md:mb-0">
      ...
      <Link
        to="/nurseryTree"
        className="bg-customTeal text-white font-medium px-6 w-1/2 mx-auto text-center py-3 rounded-full shadow-lg hover:transition"
      >
        Read More
      </Link>
    </div>
  ...
  <div className="mb-12 flex flex-col md:flex-row-reverse items-center justify-between px-6">
    <div className="md:w-1/2 flex flex-col justify-between h-full mb-6 md:mb-0">
      ...
      <Link
        to="/organic"
        className="bg-customTeal text-white font-medium px-6 py-3  w-1/2 mx-auto text-center rounded-full shadow-lg hover:transition"
      >
        Read More
      </Link>
    </div>
  ...
  <div className="mb-12 flex flex-col md:flex-row items-center justify-between px-6">
    <div className="md:w-1/2 flex flex-col justify-between h-full mb-6 md:mb-0">
      ...
      <Link
        to="/technicalAdvice"
        className="bg-customTeal text-white font-medium  w-1/2 mx-auto  text-center px-6 py-3 rounded-full shadow-lg hover:transition"
      >
        Read More
      </Link>
    </div>
